...
try:
    ...
    if COMPREHENSIVE_MODE and not INDEX_FILE_EN and not DEEP_INDEX_JSON_EN and not DEEP_INDEX_MD_EN:
        ...
        print("Expected: COMPREHENSIVE_MODE=True, all other flags=False")
        print(
            f"Actual: COMPREHENSIVE_MODE={COMPREHENSIVE_MODE}, INDEX_FILE_EN={INDEX_FILE_EN}, DEEP_INDEX_JSON_EN={DEEP_INDEX_JSON_EN}, DEEP_INDEX_MD_EN={DEEP_INDEX_MD_EN}"
        )
        sys.exit(1)
