    ...
    with app.app_context():
        ...
        try:
            ...
            if not db_conversation:
                ...
                raise AssertionError("Conversation not found in database")
            ...
            print(f"  • Total Tokens: {db_conversation.total_tokens}")
            print(
                f"  • Database: {'Supabase' if 'supabase' in os.getenv('DATABASE_URL', '') else 'Local'}"
            )

            print(f"\n{C}💡 You can now check Supabase to see this data!{E}")
            print("   1. Go to your Supabase project dashboard")
            print("   2. Navigate to Table Editor")
            print("   3. View 'admin_conversations' and 'admin_messages' tables")
