...
def main():
    ...
    try:
        ...
        print("  ✅ Created supabase_migrations schema")
        print("  ✅ Created schema_migrations table")
        print("  ✅ Synced Alembic migrations to Supabase format")
        print("  ✅ Verified all setup\n")

        print(f"{C}Next steps:{E}")
        print("  1. Refresh your Supabase Dashboard")
        print("  2. Go to Database → Migrations")
        print("  3. You should now see your migration history!")
        print("  4. Run this script again after applying new migrations\n")
