"""
Mission Domain Models for Orchestrator Service.
Migrated from Monolith to Microservice.
Strictly decoupled from 'app.core'.
"""
...
from microservices.orchestrator_service.common import (
    CaseInsensitiveEnum,
    FlexibleEnum,
    JSONText,
    utc_now,
...
class Mission(SQLModel, table=True):
    ...
    # No relationship to User table (Microservices Pattern)
    ...
    context_json: object | None = Field(default=None, sa_column=Column(JSONText))
...
# DTOs / Schemas for API
class MissionCreate(SQLModel):
    objective: str
    context: dict | None = None
    initiator_id: int = 1  # Default for now
