...
async def test_retrieve_bac_2024_probability_exercise():
    ...
    with patch("app.services.chat.tools.retrieval.remote_client.fetch_from_memory_agent", new_callable=AsyncMock) as mock_remote:
        ...
        result = await service.search_educational_content(
            query=query_text,
            **params
        )
