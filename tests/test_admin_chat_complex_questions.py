...
def test_chat_stream_handles_complex_question(client, init_database, mock_ai_gateway):
    login_admin(client)
...
def test_chat_stream_handles_long_question(client, init_database, mock_ai_gateway):
    login_admin(client)
