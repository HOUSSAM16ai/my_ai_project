...
def test_forge_new_code_with_mock_error():
    ...
    with app.app_context():
        ...
        with patch.object(
            ...
            assert short_result["meta"]["max_tokens_used"] == 4000, "Expected 4000 tokens for short question"
            ...
            assert complex_result["meta"]["max_tokens_used"] == 16000, "Expected 16000 tokens for complex question"
