...
def upgrade():
    ...
    op.create_index('idx_existential_dimensional', 'existential_nodes', ['dimension_layer', 'meta_physical_layer'])
    op.create_index(op.f('ix_existential_nodes_cosmic_hash'), 'existential_nodes', ['cosmic_hash'])
    op.create_index(op.f('ix_existential_nodes_existential_signature'), 'existential_nodes', ['existential_signature'], unique=True)
    op.create_index(op.f('ix_existential_nodes_last_consciousness_signature'), 'existential_nodes', ['last_consciousness_signature'])
    ...
    op.create_index('idx_consciousness_type_level', 'consciousness_signatures', ['entity_type', 'consciousness_level'])
    op.create_index(op.f('ix_consciousness_signatures_entity_type'), 'consciousness_signatures', ['entity_type'])
    op.create_index(op.f('ix_consciousness_signatures_signature_hash'), 'consciousness_signatures', ['signature_hash'], unique=True)
    ...
    op.create_table(
        ...
        sa.Column('metadata', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.ForeignKeyConstraint(['consciousness_id'], ['consciousness_signatures.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['existential_node_id'], ['existential_nodes.id'], ondelete='SET NULL'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_cosmic_ledger_cosmic_timestamp'), 'cosmic_ledger', ['cosmic_timestamp'])
    op.create_index(op.f('ix_cosmic_ledger_event_type'), 'cosmic_ledger', ['event_type'])
    op.create_index(op.f('ix_cosmic_ledger_ledger_hash'), 'cosmic_ledger', ['ledger_hash'], unique=True)
    op.create_index(op.f('ix_cosmic_ledger_previous_ledger_hash'), 'cosmic_ledger', ['previous_ledger_hash'])
    ...
    op.create_index(op.f('ix_seces_consciousness_signature'), 'seces', ['consciousness_signature'], unique=True)
    ...
    op.create_index(op.f('ix_existential_protocols_protocol_name'), 'existential_protocols', ['protocol_name'], unique=True)
    ...
    op.create_index(op.f('ix_cosmic_governance_councils_council_name'), 'cosmic_governance_councils', ['council_name'], unique=True)
    ...
    op.create_table(
        ...
        sa.Column('underlying_motivations', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    op.create_index('idx_transparency_event_time', 'existential_transparency_logs', ['event_type', 'recorded_at'])
    op.create_index(op.f('ix_existential_transparency_logs_event_hash'), 'existential_transparency_logs', ['event_hash'], unique=True)
    op.create_index(op.f('ix_existential_transparency_logs_event_type'), 'existential_transparency_logs', ['event_type'])
    op.create_index(op.f('ix_existential_transparency_logs_recorded_at'), 'existential_transparency_logs', ['recorded_at'])
    op.create_index(op.f('ix_existential_transparency_logs_shared_consciousness_field'), 'existential_transparency_logs', ['shared_consciousness_field'])
