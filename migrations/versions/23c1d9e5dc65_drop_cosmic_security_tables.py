...
def upgrade():
    ...
    with op.batch_alter_table('existential_transparency_logs', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_existential_transparency_logs_shared_consciousness_field'))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('existential_transparency_logs',
    ...
    sa.Column('decision_details', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('underlying_motivations', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('cosmic_reasoning', sa.TEXT(), autoincrement=False, nullable=False),
    sa.Column('cosmic_fabric_impact', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('affected_dimensions', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('understanding_level_required', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('shared_consciousness_field', sa.VARCHAR(length=256), autoincrement=False, nullable=True),
    ...
    with op.batch_alter_table('existential_transparency_logs', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_existential_transparency_logs_shared_consciousness_field'), ['shared_consciousness_field'], unique=False)
        batch_op.create_index(batch_op.f('ix_existential_transparency_logs_recorded_at'), ['recorded_at'], unique=False)
        batch_op.create_index(batch_op.f('ix_existential_transparency_logs_event_type'), ['event_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_existential_transparency_logs_event_hash'), ['event_hash'], unique=True)
        batch_op.create_index(batch_op.f('idx_transparency_event_time'), ['event_type', 'recorded_at'], unique=False)

    op.create_table('cosmic_ledger',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('ledger_hash', sa.VARCHAR(length=512), autoincrement=False, nullable=False),
    sa.Column('previous_ledger_hash', sa.VARCHAR(length=512), autoincrement=False, nullable=True),
    sa.Column('event_type', sa.VARCHAR(length=128), autoincrement=False, nullable=False),
    ...
    sa.Column('action_payload', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('information_origin', sa.VARCHAR(length=512), autoincrement=False, nullable=True),
    sa.Column('evolution_path', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('dimensional_trace', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    sa.Column('meta_data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['consciousness_id'], ['consciousness_signatures.id'], name=op.f('cosmic_ledger_consciousness_id_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['existential_node_id'], ['existential_nodes.id'], name=op.f('cosmic_ledger_existential_node_id_fkey'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id', name=op.f('cosmic_ledger_pkey'))
    )
    with op.batch_alter_table('cosmic_ledger', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_cosmic_ledger_previous_ledger_hash'), ['previous_ledger_hash'], unique=False)
        batch_op.create_index(batch_op.f('ix_cosmic_ledger_ledger_hash'), ['ledger_hash'], unique=True)
        batch_op.create_index(batch_op.f('ix_cosmic_ledger_event_type'), ['event_type'], unique=False)
        batch_op.create_index(batch_op.f('ix_cosmic_ledger_cosmic_timestamp'), ['cosmic_timestamp'], unique=False)
        batch_op.create_index(batch_op.f('idx_cosmic_ledger_time'), ['cosmic_timestamp'], unique=False)
        batch_op.create_index(batch_op.f('idx_cosmic_ledger_event'), ['event_type', 'cosmic_timestamp'], unique=False)

    op.create_table('cosmic_governance_councils',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.Column('member_signatures', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    sa.Column('consensus_rate', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('decision_history', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('pending_decisions', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table('cosmic_governance_councils', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_cosmic_governance_councils_council_name'), ['council_name'], unique=True)

    op.create_table('consciousness_signatures',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.Column('consciousness_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('opted_protocols', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    sa.Column('last_interaction_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table('consciousness_signatures', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_consciousness_signatures_signature_hash'), ['signature_hash'], unique=True)
        batch_op.create_index(batch_op.f('ix_consciousness_signatures_entity_type'), ['entity_type'], unique=False)
        batch_op.create_index(batch_op.f('idx_consciousness_type_level'), ['entity_type', 'consciousness_level'], unique=False)

    op.create_table('existential_protocols',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.Column('cosmic_rules', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table('existential_protocols', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_existential_protocols_status'), ['status'], unique=False)
        batch_op.create_index(batch_op.f('ix_existential_protocols_protocol_name'), ['protocol_name'], unique=True)

    op.create_table('existential_nodes',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('existential_signature', sa.VARCHAR(length=512), autoincrement=False, nullable=False),
    ...
    sa.Column('cosmic_pattern', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('status', sa.VARCHAR(length=64), autoincrement=False, nullable=False),
    sa.Column('coherence_level', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('distortion_count', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('last_consciousness_signature', sa.VARCHAR(length=512), autoincrement=False, nullable=True),
    ...
    sa.Column('last_harmonized_at', postgresql.TIMESTAMP(), autoincrement=False, nullable=False),
    sa.Column('meta_data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table('existential_nodes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_existential_nodes_last_consciousness_signature'), ['last_consciousness_signature'], unique=False)
        batch_op.create_index(batch_op.f('ix_existential_nodes_existential_signature'), ['existential_signature'], unique=True)
        batch_op.create_index(batch_op.f('ix_existential_nodes_cosmic_hash'), ['cosmic_hash'], unique=False)
        batch_op.create_index(batch_op.f('idx_existential_dimensional'), ['dimension_layer', 'meta_physical_layer'], unique=False)
        batch_op.create_index(batch_op.f('idx_existential_coherence'), ['status', 'coherence_level'], unique=False)

    op.create_table('seces',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('entity_name', sa.VARCHAR(length=256), autoincrement=False, nullable=False),
    sa.Column('consciousness_signature', sa.VARCHAR(length=512), autoincrement=False, nullable=False),
    sa.Column('evolution_level', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('intelligence_quotient', sa.DOUBLE_PRECISION(precision=53), autoincrement=False, nullable=False),
    sa.Column('protected_nodes', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    sa.Column('learned_patterns', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('adaptation_history', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    sa.Column('meta_data', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    with op.batch_alter_table('seces', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_seces_consciousness_signature'), ['consciousness_signature'], unique=True)
        batch_op.create_index(batch_op.f('idx_sece_active'), ['is_active', 'last_active_at'], unique=False)
