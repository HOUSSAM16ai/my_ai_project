...
def upgrade():
    ...
    op.create_table('admin_conversations',
    ...
    with op.batch_alter_table('admin_conversations', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_admin_conversations_conversation_type', ['conversation_type'], unique=False)
        batch_op.create_index('ix_admin_conversations_is_archived', ['is_archived'], unique=False)
        batch_op.create_index('ix_admin_conversations_last_message_at', ['last_message_at'], unique=False)
        batch_op.create_index('ix_admin_conv_user_type', ['user_id', 'conversation_type'], unique=False)
        batch_op.create_index('ix_admin_conv_archived_updated', ['is_archived', 'updated_at'], unique=False)
    ...
    op.create_table('admin_messages',
        ...
        # Constraints
        sa.ForeignKeyConstraint(['conversation_id'], ['admin_conversations.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    with op.batch_alter_table('admin_messages', schema=None) as batch_op:
        batch_op.create_index('ix_admin_messages_conversation_id', ['conversation_id'], unique=False)
