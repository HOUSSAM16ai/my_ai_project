...
def downgrade():
    ...
    with op.batch_alter_table('admin_conversations', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_admin_conversations_user_id'), ['user_id'], unique=False)
    ...
    with op.batch_alter_table('admin_messages', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_admin_messages_conversation_id'), ['conversation_id'], unique=False)
