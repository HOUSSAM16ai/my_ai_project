...
def upgrade():
    ...
    op.create_table('missions',
        ...
        sa.Column('status', sa.Enum('PENDING', 'PLANNING', 'PLANNED', 'RUNNING', 'ADAPTING', 'SUCCESS', 'FAILED', 'CANCELED', name='missionstatus', native_enum=False), nullable=False),
    ...
    op.create_table('mission_plans',
        ...
        sa.Column('status', sa.Enum('DRAFT', 'VALID', 'SUPERSEDED', 'FAILED', name='planstatus', native_enum=False), nullable=False),
    ...
    with op.batch_alter_table('mission_plans', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_mission_plans_content_hash'), ['content_hash'], unique=False)
    ...
    op.create_table('tasks',
        ...
        sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'SUCCESS', 'FAILED', 'RETRY', 'SKIPPED', name='taskstatus', native_enum=False), nullable=False),
    ...
    op.create_table('mission_events',
        ...
        sa.Column('event_type', sa.Enum('CREATED', 'STATUS_CHANGE', 'PLAN_SELECTED', 'EXECUTION_STARTED', 'TASK_STARTED', 'TASK_COMPLETED', 'TASK_FAILED', 'REPLAN_TRIGGERED', 'REPLAN_APPLIED', 'FINALIZED', name='missioneventtype', native_enum=False), nullable=False),
