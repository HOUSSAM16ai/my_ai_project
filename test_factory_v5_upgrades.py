...
def load_factory_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "factory", "app/overmind/planning/factory.py"
    )
...
def test_ring_buffer_functions():
    ...
    assert hasattr(factory, '_push_instantiation_profile'), "Should have _push_instantiation_profile"
...
def test_backward_compatibility():
    ...
    required_exports = [
        'discover', 'refresh_metadata', 'get_planner', 'get_all_planners',
        'list_planners', 'select_best_planner', 'batch_select_best_planners',
        'self_heal', 'planner_stats', 'describe_planner', 'diagnostics_report',
        'diagnostics_json', 'export_diagnostics', 'health_check',
        'list_quarantined', 'reload_planners'
    ]
