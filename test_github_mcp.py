...
class GitHubMCPTester:
    ...
    def test_list_repositories(self, max_repos: int = 5) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if repos:
                    self.print_success(f"Found {len(repos)} repositories (showing up to {max_repos})")
                    for repo in repos:
                        print(f"\n📦 {repo['full_name']}")
    ...
    def test_search_repositories(self, query: str = "language:python stars:>1000", max_results: int = 5) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.print_success(f"Found {data['total_count']} repositories (showing {len(repos)})")
    ...
    def run_all_tests(self):
        ...
        results.append(("Get Repository Info", self.test_get_repository_info("github", "github-mcp-server")))
