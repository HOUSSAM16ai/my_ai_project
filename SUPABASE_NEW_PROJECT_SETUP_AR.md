...
2. **subjects** - جدول المواد
3. **missions** - جدول المهام
4. **mission_plans** - جدول خطط المهام
5. **tasks** - جدول المهام الفرعية
6. **mission_events** - جدول أحداث المهام
7. **admin_conversations** - جدول محادثات الأدمن 💬
8. **admin_messages** - جدول رسائل الأدمن 💬
...
4. **c670e137ea84** - `add_admin_ai_chat_system` ⭐
   - إضافة جداول نظام المحادثات الذكية للأدمن
   - جدول `admin_conversations`
   - جدول `admin_messages`
