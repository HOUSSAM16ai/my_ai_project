...
def test_double_check_locking_pattern():
    ...
    # Should use plock
    assert 'plock' in source or '_get_plock' in source, \
        "Should use per-planner lock"
...
def run_all_tests():
    ...
    if failed == 0:
        ...
        print("✓ P0 Fixes: isinstance syntax, sandboxed import clarity, race conditions, data locking, safe int conversion")
