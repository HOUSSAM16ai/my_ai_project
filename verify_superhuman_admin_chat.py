...
def verify_implementation():
    ...
    expected_fields = [
        ...
        'deep_index_summary', 'context_snapshot', 'tags',
        'total_messages', 'total_tokens', 'avg_response_time_ms',
    ...
    expected_fields = [
        ...
        'tokens_used', 'model_used', 'latency_ms', 'cost_usd',
        'metadata_json', 'content_hash', 'embedding_vector',
