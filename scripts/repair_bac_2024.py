...
async def repair():
    ...
    try:
        async with engine.connect() as conn:
            ...
            target_name = "تمرين الاحتمالات بكالوريا 2024 شعبة علوم تجريبية"
            print(f"🔍 Finding Knowledge Nodes: '{target_name}'")
            ...
            if not nodes:
                print("❌ No knowledge nodes found to repair.")
                return

            print(f"✅ Found {len(nodes)} nodes. Updating metadata...")
            ...
            print("💪 Strengthening Content Item & Search Index...")
            ...
            if row:
                current_text = row[0]
                keywords_to_add = "\n\n[Keywords: BAC 2024, Baccalaureate 2024, Experimental Sciences, Mathematics, 2024, بكالوريا 2024]"
            ...
            await conn.commit()
            print("✨ Repair Complete! Metadata & Search Index updated.")
