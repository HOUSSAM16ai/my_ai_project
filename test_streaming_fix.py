...
complete_event = format_sse_event("complete", {"total_time_ms": 1234.5, "chunks_sent": 10})
...
metadata_event = format_sse_event(
    "metadata", {"model_used": "gpt-4", "tokens_used": 150, "elapsed_seconds": 2.5}
)
