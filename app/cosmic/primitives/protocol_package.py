...
class ExistentialProtocolPackage:
    ...
    def get_compliance_report(self) -> Dict[str, Any]:
        ...
        violations_by_severity = {"critical": 0, "error": 0, "warning": 0, "info": 0}
        ...
        return {
            ...
            "statistics": {**self.application_stats, "compliance_rate": f"{compliance_rate:.2f}%"},
    ...
    def _check_rule(self, rule: PolicyRule, data: Dict[str, Any]) -> Optional[ProtocolViolation]:
        ...
        try:
            ...
            return self._create_violation(rule, f"Validation error: {str(e)}")

    def _create_violation(self, rule: PolicyRule, description: str) -> ProtocolViolation:
        """
        إنشاء سجل انتهاك
        ...
        violation = ProtocolViolation(
            ...
            metadata={"rule_name": rule.name, "protocol_id": self.protocol_id},
        )
...
class ProtocolFactory:
    ...
    def create_custom_package(
        protocol_type: ProtocolType, name: str, description: str
    ) -> ExistentialProtocolPackage:
        """إنشاء حزمة مخصصة"""
        return ExistentialProtocolPackage(
            protocol_type=protocol_type, name=name, description=description, version="1.0.0"
        )
