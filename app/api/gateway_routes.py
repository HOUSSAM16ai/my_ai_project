...
def gateway_health():
    ...
    try:
        ...
        return jsonify({"status": "success", "data": health_status}), 200

    except Exception as e:
        current_app.logger.error(f"Gateway health check failed: {str(e)}")
        return jsonify({"status": "error", "message": "Gateway health check failed"}), 503
...
def get_routes():
    ...
    try:
        ...
        return jsonify({"status": "success", "data": {"routes": routes, "count": len(routes)}}), 200

    except Exception as e:
        current_app.logger.error(f"Error getting routes: {str(e)}")
        return jsonify({"status": "error", "message": "Failed to retrieve routes"}), 500
...
def get_services():
    ...
    try:
        ...
        return (
            jsonify({"status": "success", "data": {"services": services, "count": len(services)}}),
            200,
        )
...
def get_balancer_status():
    ...
    try:
        ...
        return jsonify({"status": "error", "message": "Failed to retrieve balancer status"}), 500
...
def routing_strategy():
    ...
    try:
        ...
        if request.method == "GET":
            ...
            return jsonify({"status": "success", "data": {"strategy": strategy}}), 200
            ...
            return (
                jsonify(
                    {"status": "success", "message": f"Routing strategy updated to {new_strategy}"}
                ),
                200,
            )
        ...
        return jsonify({"status": "error", "message": "Failed to manage routing strategy"}), 500
...
def get_feature_flags():
    ...
    try:
        ...
        return jsonify({"status": "success", "data": {"flags": flags}}), 200
...
def toggle_feature(feature_name):
    ...
    try:
        ...
        return jsonify({"status": "error", "message": "Failed to toggle feature"}), 500
...
def get_experiments():
    ...
    try:
        ...
        return jsonify({"status": "success", "data": {"experiments": experiments}}), 200

    except Exception as e:
        current_app.logger.error(f"Error getting experiments: {str(e)}")
        return jsonify({"status": "error", "message": "Failed to retrieve experiments"}), 500
    ...
    try:
        ...
        return (
            jsonify(
                {
                    "status": "success",
                    "data": {"active_experiments": experiments, "count": len(experiments)},
                }
            ),
            200,
        )
        ...
        return jsonify({"status": "error", "message": "Failed to retrieve chaos experiments"}), 500
...
def inject_chaos():
    ...
    try:
        ...
        return jsonify({"status": "error", "message": "Failed to inject chaos"}), 500
...
def get_circuit_breaker_status():
    ...
    try:
        ...
        return (
            jsonify({"status": "error", "message": "Failed to retrieve circuit breaker status"}),
            500,
        )
...
def reset_circuit_breaker(service_name):
    ...
    try:
        ...
        return jsonify({"status": "error", "message": "Failed to reset circuit breaker"}), 500
