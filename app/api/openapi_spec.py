...
OPENAPI_SPEC = {
    ...
    "info": {
        ...
        "contact": {"name": "CogniForge Team", "email": "benmerahhoussam16@gmail.com"},
        "license": {"name": "Proprietary", "url": "https://github.com/HOUSSAM16ai/my_ai_project"},
    },
    "servers": [
        {"url": "http://localhost:5000", "description": "Development server"},
        {"url": "https://api.cogniforge.com", "description": "Production server"},
    ],
    "tags": [
        {"name": "Health", "description": "Health check endpoints"},
        {"name": "Users", "description": "User management CRUD operations"},
        {"name": "Missions", "description": "Mission management CRUD operations"},
        {"name": "Tasks", "description": "Task management CRUD operations"},
        {"name": "Security", "description": "Authentication and security operations"},
        {"name": "Observability", "description": "Monitoring and metrics"},
        {"name": "Gateway", "description": "API Gateway control"},
    ],
    "paths": {
        "/api/v1/health": {
            "get": {
        ...
        "/api/security/token/generate": {
            "post": {
                ...
                "requestBody": {
                    ...
                    "content": {
                        "application/json": {
                            "schema": {"$ref": "#/components/schemas/TokenGenerateRequest"}
                        }
                    },
                },
                "responses": {
