...
class UltraHyperPlanner(BasePlanner):
    ...
    def _core_planning_logic(
        ...
        # 1. Repo Scan & Extra Sources
        idx = self._step_scan_repo_and_extras(tasks, idx, analysis_dependency_ids, objective)
        ...
        # 3. Semantic Analysis (Structure & Global Summary)
    ...
    def _build_meta(
        ...
        return {
            ...
            "global_code_summary_task": global_summary_id,
