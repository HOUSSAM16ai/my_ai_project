...
class SelfAdaptiveMicroservices:
        ...
        with self.lock:
            for instance in self.services[service_name]:
                if instance.instance_id == instance_id:
                    ...
                    health, warnings = self.health_monitor.analyze_health(
    ...
    def _aggregate_metrics(
        ...
        if not metrics_list:
            return ServiceMetrics(
                ...
                error_rate=0, latency_p50=0, latency_p95=0,
                latency_p99=0, active_connections=0, queue_depth=0
            )
    ...
    def _scale_down(self, service_name: str, count: int):
        ...
        instances.sort(key=lambda i: i.metrics_history[-1].active_connections if i.metrics_history else 0)
