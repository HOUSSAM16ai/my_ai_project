...
class BehaviorPattern(Enum):
    ...
    POWER_USER = "power_user"  # High frequency, high engagement
    CASUAL_USER = "casual_user"  # Low frequency, moderate engagement
    CHURNING = "churning"  # Declining activity
    GROWING = "growing"  # Increasing activity
    SEASONAL = "seasonal"  # Periodic activity
...
class BehaviorProfile:
    ...
    def is_valuable(self) -> bool:
        """Check if user has high lifetime value."""
        return self.lifetime_value_estimate > 1000.0
