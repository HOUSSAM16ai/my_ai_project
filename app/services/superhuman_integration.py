        ...
        status = {
            ...
            'systems': {
                'microservices': {
                    ...
                    ] if MICROSERVICES_AVAILABLE else []
                },
                'intelligent_testing': {
                ...
                'project_management': {
                    ...
                    ] if PROJECT_MGMT_AVAILABLE else []
                }
            },
...
"""
        ...
        for rec in recommendations:
            report += f"### {rec['title']}\n"
            report += f"**Category:** {rec['category']} | **Priority:** {rec['priority'].upper()}\n\n"
