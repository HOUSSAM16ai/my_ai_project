...
def build_project_structure(project_root: Path) -> dict[str, object]:
    ...
    for dir_name in TARGET_DIRECTORIES:
        ...
        if target_dir.exists():
            ...
            structure["total_functions"] = int(structure["total_functions"]) + dir_stats["total_functions"]
            structure["total_classes"] = int(structure["total_classes"]) + dir_stats["total_classes"]
