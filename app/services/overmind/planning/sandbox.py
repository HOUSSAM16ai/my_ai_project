# app.services.overmind/planning/sandbox.py
# ======================================================================================
...
def import_in_sandbox(
    ...
    Example:
        >>> mod = import_in_sandbox("app.services.overmind.planning.llm_planner", timeout_s=3.0)
    """
...
def safe_import(module_name: str, fallback: ModuleType | None = None) -> ModuleType | None:
    ...
    Example:
        >>> mod = safe_import("app.services.overmind.planning.llm_planner")
        >>> if mod is None:
        ...     print("Import failed")
    """
    try:
