...
class SecurityMetricsEngine:
    ...
    def __init__(
        self,
        risk_calculator: AdvancedRiskCalculator | None = None,
        metrics_calculator: ComprehensiveMetricsCalculator | None = None,
        predictor: LinearRegressionPredictor | None = None,
        ...
        self.metrics_calculator = metrics_calculator or ComprehensiveMetricsCalculator()
    ...
    def predict_future_risk(
        ...
        """Predict future risk"""
        return self.predictor.predict_future_risk(historical_metrics, days_ahead)

    def calculate_comprehensive_metrics(
        self, findings: list[SecurityFinding], code_metrics: dict | None = None
    ) -> SecurityMetrics:
        """Calculate comprehensive metrics"""
        metrics = self.metrics_calculator.calculate_metrics(findings, code_metrics)
        metrics.overall_risk_score = self.calculate_advanced_risk_score(findings, code_metrics)
        return metrics
