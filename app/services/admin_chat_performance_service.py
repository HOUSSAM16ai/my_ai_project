...
class AdminChatPerformanceService:
    ...
    def get_statistics(self, category: str | None = None, hours: int = 24) -> dict[str, Any]:
        """
    ...
    def assign_ab_variant(self, user_id: int) -> ABTestVariant:
        ...
        # Use hash for uniform distribution - SHA256 for consistent variant assignment
        import hashlib
    ...
    def get_optimization_suggestions(self) -> list[str]:
        ...
        streaming_pct = (
            stats["category_breakdown"].get("streaming", 0) / stats["total_requests"] * 100
        )
        ...
        # Positive feedback
        excellent_pct = perf_dist.get("excellent", 0) / stats["total_requests"] * 100
        ...
        return (
            suggestions
            if suggestions
            else ["✅ Performance is optimal! No suggestions at this time."]
        )
