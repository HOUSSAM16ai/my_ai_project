...
class ChaosMonkeyService:
    ...
    def enable_chaos_monkey(self, mode: ChaosMonkeyMode = ChaosMonkeyMode.SCHEDULED):
        ...
        with self.lock:
            ...
            current_app.logger.info(
                f"🐒 Chaos Monkey enabled in {mode.value} mode"
            )
    ...
    def execute_chaos_experiment(
        ...
        with self.lock:
            ...
            try:
                ...
                execution.passed = (
                    execution.system_recovered and
                    execution.recovery_time_seconds < 300 and  # 5 minutes
                    execution.error_rate_after < execution.error_rate_before * 1.1
                )
    ...
    def _generate_lessons(self, execution: ChaosExecution) -> List[str]:
        ...
        if execution.recovery_time_seconds > 300:
            lessons.append(f"Recovery took {execution.recovery_time_seconds:.0f}s - exceeds 5-minute SLA")
