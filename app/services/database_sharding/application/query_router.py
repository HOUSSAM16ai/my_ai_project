...
class QueryRoutingService:
    ...
    def is_cross_shard_query(self, route: QueryRoute) -> bool:
        """Check if query spans multiple shards."""
        return route.is_cross_shard or len(route.shard_ids) > 1
