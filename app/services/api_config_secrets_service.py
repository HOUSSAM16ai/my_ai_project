...
class ConfigSecretsService:
    ...
    def get_config(
        self, environment: Environment, key: str, default: Any = None
    ) -> Any:
    ...
    def rotate_secret(
        self, secret_id: str, new_value: str, accessed_by: str = "system"
    ) -> bool:
    ...
    def _log_access(self, secret_id, accessed_by, action, success, reason=None):
        return self._manager._log_access(
            secret_id, accessed_by, action, success, reason
        )
