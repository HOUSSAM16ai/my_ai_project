"""
ناقل الأحداث المركزي (Event Bus).

تطبيق لنمط النشر/الاشتراك لإدارة التواصل غير المتزامن بين الخدمات.
"""
...
from app.core.event_bus_pkg.history import EventHistory
