...
def check_health():
    ...
    try:
        ...
        click.echo("\n" + "=" * 60)
        click.echo("✅ Health check complete!" if health['status'] == 'healthy' else "⚠️ Issues detected!")
...
def optimize():
    ...
    try:
        ...
        click.echo("\n" + "=" * 60)
        click.echo("✅ Optimization complete!" if result['status'] == 'success' else "⚠️ Optimization had issues")
    ...
    try:
        ...
        for category in sorted(categories.keys()):
            ...
            for table in categories[category]:
                ...
                click.echo(f"  {icon} {name:<25} {count:>8,} records  {recent:>5} new  {cols:>3} cols  {desc}")
