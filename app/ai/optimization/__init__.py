# app/ai/optimization/__init__.py
"""
...
class ResponseDeduplicator:
    ...
    def deduplicate(
        ...
        If same key is already executing, wait for that result.
        Otherwise, execute and share result with waiters.
        ...
        with self._lock:
            if key in self._in_flight:
                event, result_container = self._in_flight[key]
                _LOG.debug(f"Deduplicating request: {key}")
