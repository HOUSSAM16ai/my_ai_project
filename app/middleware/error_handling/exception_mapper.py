...
class ExceptionMapper:
    ...
    @classmethod
    def register_exception(cls, exception_type: type, status_code: int, message: str) -> None:
        """
        ...
        """
        cls.EXCEPTION_MAP[exception_type] = {"status_code": status_code, "message": message}
