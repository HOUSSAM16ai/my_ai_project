...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "root", nargs="?", default=Path.cwd(), type=Path, help="مسار الجذر المراد مسحه"
    )
    parser.add_argument(
        "--include-hidden", action="store_true", help="إظهار الملفات والمجلدات المخفية"
    )
