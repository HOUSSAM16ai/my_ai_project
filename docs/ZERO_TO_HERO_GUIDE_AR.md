...
هذا هو "موزع الأدوات". بدلاً من أن يعرف كل ملف كيف يصنع أدواته (مما يسبب فوضى وتشابك)، يطلبون الأداة من النظام، ويقوم هذا الملف بتوفيرها.
- مثال: "أريد خدمة قاعدة البيانات" -> النظام يقوم "بحقن" (Inject) الخدمة الجاهزة للدالة التي طلبتها.
...
3. **الحقن**: يطلب الراوتر خدمة `auth_service` عبر `Depends`.
...
- **Dependency Injection (`Depends(...)`)**: طريقة لطلب الأدوات. بدلاً من صنع "مفك براغي" جديد كل مرة، تطلبه من النظام "أعطني مفك البراغي الجاهز". هذا هو المعيار الذهبي في هندسة البرمجيات الحديثة.
