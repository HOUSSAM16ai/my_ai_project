...
The heart of the system is the **Reality Kernel**, located in `app/kernel.py`. It is the single source of truth for the application's existence. It establishes a unified FastAPI application object that bridges the legacy WSGI world with the modern ASGI reality.
